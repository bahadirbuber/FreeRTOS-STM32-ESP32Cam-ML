...
ai_buffer g_face_recognition_data_map_weights[AI_FACE_RECOGNITION_DATA_WEIGHTS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    411492, NULL, s_face_recognition_weights_array_u64),   /* weights_array */
  };
...
ai_buffer ai_face_recognition_data_activations_buffer_get(const ai_handle ptr)
{
  ai_buffer buf = AI_BUFFER_INIT(
    ...
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, AI_FACE_RECOGNITION_DATA_ACTIVATIONS_SIZE, 1, AI_FACE_RECOGNITION_DATA_ACTIVATIONS_COUNT),
    AI_FACE_RECOGNITION_DATA_ACTIVATIONS_SIZE,
    NULL, ptr);
  return buf;
}
...
ai_buffer ai_face_recognition_data_weights_buffer_get(const ai_handle ptr)
{
  ai_buffer buf = AI_BUFFER_INIT(
    ...
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, AI_FACE_RECOGNITION_DATA_WEIGHTS_SIZE, 1, AI_FACE_RECOGNITION_DATA_WEIGHTS_COUNT),
    AI_FACE_RECOGNITION_DATA_WEIGHTS_SIZE,
    NULL, ptr);
  return buf;
}
...
{
  return AI_HANDLE_PTR(g_face_recognition_weights_table);
