/**
  ...
  ******************************************************************************
  */
#ifndef AI_FACE_RECOGNITION_H
#define AI_FACE_RECOGNITION_H

#include "face_recognition_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_FACE_RECOGNITION_MODEL_NAME          "face_recognition"
#define AI_FACE_RECOGNITION_ORIGIN_MODEL_NAME   "mobilenet_v2_0_35_128_fft_int8"

/******************************************************************************/
#define AI_FACE_RECOGNITION_ACTIVATIONS_ALIGNMENT   (4)
#define AI_FACE_RECOGNITION_INPUTS_IN_ACTIVATIONS   (4)
#define AI_FACE_RECOGNITION_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_FACE_RECOGNITION_IN_NUM        (1)

AI_DEPRECATED
#define AI_FACE_RECOGNITION_IN \
  ai_face_recognition_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_FACE_RECOGNITION_IN_SIZE { \
  AI_FACE_RECOGNITION_IN_1_SIZE, \
}
#define AI_FACE_RECOGNITION_IN_SIZE_BYTES { \
  AI_FACE_RECOGNITION_IN_1_SIZE_BYTES, \
}
#define AI_FACE_RECOGNITION_IN_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_FACE_RECOGNITION_IN_1_HEIGHT      (128)
#define AI_FACE_RECOGNITION_IN_1_WIDTH       (128)
#define AI_FACE_RECOGNITION_IN_1_CHANNEL     (3)
#define AI_FACE_RECOGNITION_IN_1_SIZE        (49152)
#define AI_FACE_RECOGNITION_IN_1_SIZE_BYTES  (49152)

/******************************************************************************/
#define AI_FACE_RECOGNITION_OUT_NUM       (1)

AI_DEPRECATED
#define AI_FACE_RECOGNITION_OUT \
  ai_face_recognition_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_FACE_RECOGNITION_OUT_SIZE { \
  AI_FACE_RECOGNITION_OUT_1_SIZE, \
}
#define AI_FACE_RECOGNITION_OUT_SIZE_BYTES { \
  AI_FACE_RECOGNITION_OUT_1_SIZE_BYTES, \
}
#define AI_FACE_RECOGNITION_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_FACE_RECOGNITION_OUT_1_CHANNEL     (1)
#define AI_FACE_RECOGNITION_OUT_1_SIZE        (1)
#define AI_FACE_RECOGNITION_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_FACE_RECOGNITION_N_NODES (84)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup face_recognition
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_face_recognition_get_info(
 ...
 */
AI_API_ENTRY
ai_bool ai_face_recognition_get_report(
  ai_handle network, ai_network_report* report);
 ...
 */
AI_API_ENTRY
ai_handle ai_face_recognition_destroy(ai_handle network);
 ...
 * @ref ai_face_recognition_create. Both the activations memory buffer 
 ...
 * using @ref ai_face_recognition_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_face_recognition_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_face_recognition_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_FACE_RECOGNITION_*
 * defines into file @ref face_recognition.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_face_recognition_run(
 ...
 */
AI_API_ENTRY
ai_i32 ai_face_recognition_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_FACE_RECOGNITION_H */
