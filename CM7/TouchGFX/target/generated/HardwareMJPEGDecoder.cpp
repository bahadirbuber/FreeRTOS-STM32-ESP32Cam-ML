...
__weak uint8_t MCU_Data_OutBuffer0[CHUNK_SIZE_OUT];
__weak uint8_t MCU_Data_OutBuffer1[CHUNK_SIZE_OUT];

uint8_t MCU_Cropping_Buffer[MCU_WIDTH_PIXELS * MCU_HEIGHT_PIXELS * 3];

__weak __IO uint32_t MCU_BlockIndex = 0;
...
__weak volatile uint32_t JPEG_OUT_Read_BufferIndex = 0;
volatile uint32_t DMA2D_CopyBufferEnd = 0;

__weak JPEG_Data_BufferTypeDef Jpeg_OUT_BufferTab[NB_OUTPUT_DATA_BUFFERS] =
{
 ...
 */
__weak uint32_t JPEG_OutputHandler(JPEG_HandleTypeDef* hjpeg)
{
 ...
 * @retval None
 */
__weak void DMA2D_CopyBuffer(JPEG_Data_BufferTypeDef& job)
{
 ...
 * @retval None
 */
__weak void DMA2D_CropBuffer(JPEG_Data_BufferTypeDef& job)
{
 ...
 * @retval None
 */
__weak void DMA2D_ExternalJobCompleted(JPEG_Data_BufferTypeDef& job)
{
